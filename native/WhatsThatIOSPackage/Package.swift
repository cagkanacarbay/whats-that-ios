...
// No targets in this package use bundle resources. Setting `resources: []` disables
// SPM's auto-discovery of non-Swift files (like .md) as resources. This prevents
// CLAUDE.md files (generated by claude-mem) from being bundled, which would cause
// "Multiple commands produce CLAUDE.md" build errors.
let noResources: [Resource] = []
