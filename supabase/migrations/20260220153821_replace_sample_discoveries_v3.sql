-- Migration: Replace sample discoveries with curated set of 20
-- Replaces v2 set (22 discoveries). Removed: The Empress's Pink Stone, Feast in the House of Levi.
-- Reordered for stronger visual variety in the opening rows.
--
...
--   Row 2:  The Arm of a Saint           | The Doge's Giant Ego
--   Row 3:  The Merchant's Moral Map     | The Wood Inlays of Frari
--   Row 4:  The Winged Hussars           | Inferno in the Palace
--   Row 5:  Ghetto Heroes Monument       | Accidental Sticky Notes
--   Row 6:  Trakai's Diverse Streets     | Sobieski at Vienna
--   Row 7:  Polyxena Sarcophagus         | Palace of Culture
--   Row 8:  The Price of Fire            | A Map to the Afterlife
--   Row 9:  Ornate Wheellock             | The Rebel Monk Methodius
--   Row 10: Rundāle Palace               | Stoves of Rundāle
...
-- -------------------------------------------------------------------------
-- Row 2, Left: The Arm of a Saint (dev ID 309)
-- -------------------------------------------------------------------------
(3,
 'The Arm of a Saint',
...
-- -------------------------------------------------------------------------
-- Row 2, Right: The Doge's Giant Ego (dev ID 174)
-- -------------------------------------------------------------------------
(4,
...
-- -------------------------------------------------------------------------
-- Row 3, Left: The Merchant's Moral Map (dev ID 134)
-- -------------------------------------------------------------------------
(5,
...
-- -------------------------------------------------------------------------
-- Row 3, Right: The Wood Inlays of Frari (dev ID 307)
-- -------------------------------------------------------------------------
(6,
...
-- -------------------------------------------------------------------------
-- Row 4, Left: The Winged Hussars (dev ID 183)
-- -------------------------------------------------------------------------
(7,
 'The Winged Hussars',
...
-- -------------------------------------------------------------------------
-- Row 4, Right: Inferno in the Palace (dev ID 177)
-- -------------------------------------------------------------------------
(8,
...
-- -------------------------------------------------------------------------
-- Row 5, Left: Ghetto Heroes Monument (dev ID 316)
-- -------------------------------------------------------------------------
(9,
...
-- -------------------------------------------------------------------------
-- Row 5, Right: Accidental Sticky Notes (dev ID 219)
-- -------------------------------------------------------------------------
(10,
...
-- -------------------------------------------------------------------------
-- Row 6, Left: Trakai's Diverse Streets (dev ID 229)
-- -------------------------------------------------------------------------
(11,
...
-- -------------------------------------------------------------------------
-- Row 6, Right: Sobieski at Vienna (prod ID 1771)
-- -------------------------------------------------------------------------
(12,
 'Sobieski at Vienna',
...
-- -------------------------------------------------------------------------
-- Row 7, Left: Polyxena Sarcophagus (dev ID 40)
-- -------------------------------------------------------------------------
(13,
...
-- -------------------------------------------------------------------------
-- Row 7, Right: Palace of Culture (dev ID 237)
-- -------------------------------------------------------------------------
(14,
 'Palace of Culture',
...
-- -------------------------------------------------------------------------
-- Row 8, Left: The Price of Fire (dev ID 125)
-- -------------------------------------------------------------------------
(15,
 'The Price of Fire',
...
-- -------------------------------------------------------------------------
-- Row 8, Right: A Map to the Afterlife (dev ID 57)
-- -------------------------------------------------------------------------
(16,
...
-- -------------------------------------------------------------------------
-- Row 9, Left: Ornate Wheellock (dev ID 261)
-- -------------------------------------------------------------------------
(17,
 'Ornate Wheellock',
...
-- -------------------------------------------------------------------------
-- Row 9, Right: The Rebel Monk Methodius (dev ID 173)
-- -------------------------------------------------------------------------
(18,
...
-- -------------------------------------------------------------------------
-- Row 10, Left: Rundāle Palace (dev ID 298)
-- -------------------------------------------------------------------------
(19,
 'Rundāle Palace',
...
-- -------------------------------------------------------------------------
-- Row 10, Right: Stoves of Rundāle (dev ID 199)
-- -------------------------------------------------------------------------
(20,
 'Stoves of Rundāle',
